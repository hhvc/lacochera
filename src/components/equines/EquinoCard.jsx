...
export const EquinoCard = ({ item, index }) => {
  ...
  return (
    <Card style={{ width: "18rem" }} className="mx-auto m-2">
      ...
      <Card.Body>
        ...
        <Card.Text>{item.RAZA}</Card.Text>
        <Card.Text>Criador: {item.CRIADOR}</Card.Text>
        <Card.Text>Nacimiento: {item.FECHANACIMIENTO}</Card.Text>
        <Card.Text>Sexo: {item.SEXO}</Card.Text>
